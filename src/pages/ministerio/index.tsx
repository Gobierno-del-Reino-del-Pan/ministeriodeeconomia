        ...
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: '2.5rem', alignItems: 'start' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--muted-foreground)', lineHeight: 1.75, marginBottom: '2rem' }}>
              Corresponde al Ministerio la elaboración y seguimiento de los presupuestos generales del Estado en colaboración con el resto de departamentos ministeriales, así como la supervisión de las entidades públicas empresariales bajo su tutela.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem' }}>
              {[
                { title: 'Secretaría de Estado de Economía', href: '/ministerio/secretarias' },
                { title: 'Secretaría de Estado de Comercio', href: '/ministerio/secretarias' },
                { title: 'Secretaría de Estado de Empleo', href: '/ministerio/secretarias' },
              ].map((o) => (
