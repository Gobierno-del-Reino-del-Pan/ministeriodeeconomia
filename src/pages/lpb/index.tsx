...
const SERVICIOS = [
  { icon: '📋', label: 'Trámites y solicitudes',      href: '/lpb/tramites',       desc: 'Registro de documentos, solicitudes de licencias y gestiones administrativas.' },
  { icon: '🔔', label: 'Notificaciones electrónicas', href: '/lpb/notificaciones', desc: 'Consulte las notificaciones y comunicaciones dirigidas a su persona o empresa.' },
];
